# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 15:19:24 2013
...
# 
# ----------------------------------------------------------------------
# This PyMOL Plugin is Copyright (C) 2013 by Hu Ge <gehuchina@gmail.com>
# 
#                        All Rights Reserved
# 
...
def setParamDialog(app):
    ...
    def B1Click():
        ...
        DIHT=float(E4.get())
        PDBFILE=''
        PDBFILE=tkFileDialog.askopenfilename(filetypes=[("PDB(Protein Data Bank files","*.pdb"),("PDB(Protein Data Bank files","*.ent"),('All files', '*')],title='Please select your PDB file for analysis')
